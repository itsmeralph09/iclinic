...
if (isset($_POST['user_id']) && is_numeric($_POST['user_id'])) {
    ...
    $sql = "UPDATE user_tbl SET status = 'APPROVED' WHERE user_id='$user_id'";
    ...
    if (mysqli_query($con, $sql)) {
        ...
        $parameters = [
            'apikey' => $apiKey,
            'number' => $user_contact,
            'message' => 'Good Day! ' . $user_fullname . '. Your registration for the iClinic - PRMSU Candelaria Clinic Management System has been APPROVED. You may now log in and update your account information.',
