                ...
                if (response.success) {
                    ...
                    setTimeout(() => {
                        ...
                        if (role === "ADMIN") {
                            ...
                            window.location.href = './student/index.php'; // Redirect to employee page
                        } else if (role === "EMPLOYEE") {
                            window.location.href = './employee/index.php'; // Redirect to student page
                        }
                    }, 1000); // Adjust the delay time as needed (in milliseconds)
                }
                 else {
                    // If AJAX request is successful but response indicates error, show SweetAlert error message
                    showWarningMessage2(response.message || 'Invalid student/employee number or password. Please try again.');
                }
            } else {
