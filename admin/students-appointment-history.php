...
<body id="page-top">
    <div class="d-none" id="students-appointment-history"></div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                        $student_user_id = urldecode($_GET['id']);
                        $student_user_name = urldecode($_GET['name']);
                    ?>

                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Appointment History of <span class="text-primary"><?php echo $student_user_name; ?></span></h1>
                        <a href="students-approved.php" class="btn btn-sm btn-secondary"><i class="fa-solid fa-arrow-left mr-1"></i>Back</a>     
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-column flex-md-row">
                                    <div class="col-12 col-md-6 d-flex align-items-center justify-content-start mx-0 px-0 mb-2 mb-md-0">
                                        <h6 class="font-weight-bold text-primary mb-0">List of Completed Appointments</h6>
                                    </div>
                                        ...
                                        <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php
                                                ...
                                                $display_appointments = "
                                                                    ...
                                                                    WHERE apt.deleted = 0 AND ut.role = 'STUDENT' AND apt.appointment_status = 'COMPLETED' AND apt.user_id = '$student_user_id'
                                                                    ";
