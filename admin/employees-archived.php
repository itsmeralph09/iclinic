...
<body id="page-top">
    <div class="d-none" id="employees-archived"></div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Archived Employees</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">List of Archived Employees</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <tr>         
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="btn btn-sm btn-info restore-employee-btn"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.restore-employee-btn').on('click', function(e) {
                e.preventDefault();
                ...
                Swal.fire({
                    title: 'Restore Deleted Employee Account',
                    html: "You are about to restore the following employee:<br><br>" +
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: 'action/restore_employee.php', // Corrected 'file' to 'url'
                            type: 'POST',
                            data: {
                                user_id: userId
                            },
