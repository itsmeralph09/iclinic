...
<body id="page-top">
    <div class="d-none" id="students-appointment-declined"></div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Student Declined Appointments</h1>
                            ...
                            <div class="card shadow mb-4">
								...
								<div class="card-header py-3 d-flex flex-column flex-md-row">
								    <div class="col-12 col-md-6 d-flex align-items-center justify-content-start mx-0 px-0 mb-2 mb-md-0">
								        <h6 class="font-weight-bold text-primary mb-0">List of Student Declined Appointments</h6>
								    </div>
                                        ...
                                        <table class="table table-bordered nowrap" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php
                                                ...
                                                $display_appointments = "
																	...
																	WHERE apt.deleted = 0 AND ut.role = 'STUDENT' AND apt.appointment_status = 'DECLINED'
                                                					";
