                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="mr-1">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control-plaintext custom-readonly-input" id="student_no" value="<?php echo $student_no; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control-plaintext custom-readonly-input" id="course" value="<?php echo $course; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control-plaintext custom-readonly-input" id="year" value="<?php echo $year; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>                                           
